...
namespace OnePipe.Weather.Common.Contracts
{
    ...
    public class Response<T> where T : class//: Response
    {
        ...
        public static Response<T> Failed(string errorMessage, List<string> validationmessages = null)
        {
            var response = new Response<T> { ResultType = ResultType.Error, Message = errorMessage, ValidationMessages = validationmessages };
